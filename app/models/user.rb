...
class User < ApplicationRecord
  ...
  has_many :wearable_hats, -> { where(doffed_at: nil) },
    class_name: "Hat",
    inverse_of: :user
  has_many :hat_requests, dependent: :restrict_with_error
  has_many :notifications, dependent: :restrict_with_error
  has_many :hidings,
    class_name: "HiddenStory",
    inverse_of: :user,
    dependent: :destroy
  has_many :read_ribbons, dependent: :restrict_with_error
  has_many :saved_stories, dependent: :restrict_with_error
  has_many :suggested_taggings, dependent: :restrict_with_error
  has_many :suggested_titles, dependent: :restrict_with_error
