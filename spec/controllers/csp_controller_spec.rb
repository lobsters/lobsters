    ...
    it 'records the violation' do
      body = {
        "csp-report" => {
          ...
          "original-policy" => "default-src 'none'; img-src *; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; form-action 'self'; report-uri http://localhost:3000/csp-violation-report",
